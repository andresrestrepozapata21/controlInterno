...
$sentencia = "SELECT * FROM contrato cto JOIN contratista cta ON cta.fk_id_contrato=cto.id_contrato JOIN dependencia d ON d.id_dependencia=cto.fk_id_dependencia WHERE id_contrato=$id_contrato";
...
if (mysqli_num_rows($resultado) > 0) {
  ...
  $nombreContratista = $nombres . $apellidos;
  ...
  $sentencia3 = "SELECT * from contratista where fk_id_contrato = $id_contrato";
  $resultado3 = $conexion->query($sentencia3);
  $fila3 = $resultado3->fetch_object();
  $id_contratista = $fila3->id_contratista;
}
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="main-card mb-3 card">
            <div class="card-body">
              <h5 class="card-title">Detalles del Contrto</h5>
              <table class="mb-0 table table-bordered">
                <tbody>
                  ...
                  <tr>
                    <th scope="row"><b>Nombre del Contratista</b></th>
                    <td><?php echo $nombreContratista; ?></td>
                  </tr>
                  <tr>
          ...
          <div id="tracking">
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <div>
                  <form action="pre2_informe_supervision.php" target="blank" method="POST">
                    <table>
                      <tr>
