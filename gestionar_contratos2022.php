                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                $sentencia = "SELECT contrato.id_contrato,contrato.numero,contrato.nombre,contrato.fecha_inicio,contrato.fecha_fin,contrato.objeto,contrato.valor,dependencia.nombre as nombre_dependencia, contratista.id_contratista, contratista.nombres, contratista.apellidos FROM contrato inner join dependencia on contrato.fk_id_dependencia=dependencia.id_dependencia INNER JOIN contratista ON contratista.fk_id_contrato = contrato.id_contrato where contrato.activo=1 AND contrato.fecha_inicio BETWEEN '2022/01/01' AND '2022/12/31' order by contrato.id_contrato desc;";
                                //echo $sentencia;
